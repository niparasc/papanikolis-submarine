...
public class BluetoothManager implements BluetoothInterface {
	...
	// Message types sent from the Handler (used only for read messages, for now)
...
//    private Array<TransmissionPackage> incomingPackages = new Array<TransmissionPackage>();
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_READ:
                ...
                try {
                    ...
                    TransmissionPackage transmissionPackage = (TransmissionPackage) SerializationUtils.deserialize(readBuf);
                    
                    // Notify game about incoming data
                    currentActivity.getPapanikolis().notify_PeerDataReceived(transmissionPackage);
...
//                    incomingPackages.add(transmissionPackage);
	...
	public boolean isBluetoothDiscoverable() {
		return (bluetoothAdapter.getScanMode() == BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE) ? true : false;
	}
	...
	public void enableBluetoothDiscoverability() {
		...
		currentActivity.startActivityForResult(discoverableIntent, REQUEST_ENABLE_BT_DISCOVERABILITY);
	}
