...
public class MainActivity extends AndroidApplication {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothAdapter.ACTION_SCAN_MODE_CHANGED.equals(action)) {
				...
				case BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE:
					Gdx.app.log(LOG, "BroadcastReceiver: SCAN_MODE_CONNECTABLE_DISCOVERABLE");
			...
			// When discovery finds a device
				...
				// Add the discovered device to bluetooth manager's list of discovered devices
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        vibratorManager = new VibratorManager((Vibrator) getSystemService(Context.VIBRATOR_SERVICE));
...
//    	this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    // Called to get the result of the user's decision to enable BT (and/or make it discoverable) or not.
