...
public class Papanikolis extends Game {
	...
	public Papanikolis(BluetoothInterface bluetoothInterface, VibratorInterface vibrator) {
	...
	public void create() {
		...
		assetManager.load("papanikolis/submarine-crashed-64x32.png", Texture.class);
		assetManager.load("papanikolis/peer-submarine-64x32.png", Texture.class);
		assetManager.load("papanikolis/peer-submarine-crashed-64x32.png", Texture.class);
		// Load assets
	...
	/* Event notifications on Bluetooth coming from MainActivity --> BluetoothAdapter */
...
//			bluetoothInterface.startConnectionListening();
	...
	public void notify_BT_DEVICE_FOUND() {
		...
		if (getScreen() instanceof JoinScreen) {
			// Sometimes ACTION_FOUND is fired even when not discovering (a bug?)
	...
	public void notify_PeerDataReceived(TransmissionPackage transmissionPackage) {
		MultiplayerDirector director = (MultiplayerDirector) ((Game1)getScreen()).getDirector();
