...
//		Gdx.app.log(LOG, "RECEIVED: " + transmissionPackage.toString());
		if (((Game1)game.getScreen()).getState() == State.READINESS_TEST) {
			...
			randomPointXDistance = transmissionPackage.getRandomPointXDistance();
			randomPointYDistance = transmissionPackage.getRandomPointYDistance();
			randomYObstacleDistance = transmissionPackage.getRandomYObstacleDistance();
