...
public class PeerSubmarine extends Box2DActor {
	...
	public PeerSubmarine(Papanikolis game, Box2DStage gameStage, float x, float y) {
		super(game, gameStage);
		peerSubmarine = new TextureRegion(game.getAssetManager().get("papanikolis/peer-submarine-64x32.png", Texture.class));
		setPosition(x, y);
...
//	}
	 ...
	 */
	public void crashed() {
		peerSubmarine.setTexture(game.getAssetManager().get("papanikolis/peer-submarine-crashed-64x32.png", Texture.class));
		crashed = true;
	}
