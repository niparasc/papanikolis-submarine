...
public class Surface extends Box2DActor {
	...
	// The mirror points of the surface, used to fill the surface with colored triangles.
	private Array<Vector2> mirror;
	
	public Surface(Papanikolis game, Box2DStage gameStage, Array<Vector2> surface) {
...
/*		shapeRenderer.begin(ShapeType.Line);
		...
		for (int i = 0; i < surface.size - 1; i++) {
			...
			Vector2 point2 = surface.get(i + 1);
...
//		shapeRenderer.end();
	...
	public void createBody() {
		...
		for (int i = 0; i < vertices.length; i++) {
			...
			vertices[i] = new Vector2(gameStage.convertToBox(worldV.x), gameStage.convertToBox(worldV.y));
		}
	 ...
	 * and chain shape.
	 * 
	 * TODO: Couldn't make it work like this: get shape, destroy fixture, create fixture
	 * with the same (updated) shape.
	 */
