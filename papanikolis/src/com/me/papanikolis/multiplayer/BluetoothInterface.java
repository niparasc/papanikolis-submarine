...
public interface BluetoothInterface {
	...
	/**
	 * Return true if Bluetooth is discoverable. Being discoverable means it is already enabled.
	 * 
	...
	/**
	 * Get all devices (paired and discovered). First the paired are fetched and then the discovered
	 * are placed on top of them and the final set is returned.
	 * 
	 * @return set with strings of paired and discovered devices, each containing the device's name and address
	 */
	...
	/**
	 * Cancels the AcceptThread's listening socket and causes the thread to finish.
	 */
	...
	/**
	 * Return the next (first in queue) TransmissionPackage that came from the peer.
	 * If the queue is empty null is returned.
	 * 
	 * @return the first in queue TransmissionPackage received from the peer or null if
	 * the queue is empty
	 */
