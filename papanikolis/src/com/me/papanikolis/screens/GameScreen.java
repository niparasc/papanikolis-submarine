...
public abstract class GameScreen extends AbstractScreen {
	...
	public void resize(int width, int height) {
		...
		gameStage.setViewport(Papanikolis.VIEWPORT_WIDTH,
	...
	/*
	 * Factory method for creating Directors. The concrete subclasses know which
	 * kind of director they need.
	 */
	protected abstract Director createDirector(Papanikolis game,
			Box2DStage gameStage);
