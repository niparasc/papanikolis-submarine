...
public class Submarine extends Box2DActor {
	...
	public Submarine(Papanikolis game, Box2DStage gameStage, float x, float y) {
		...
		submarine = new TextureRegion(game.getAssetManager().get(
				"papanikolis/submarine-64x32.png", Texture.class));
		setPosition(x, y);
	...
	public void createBody(float x, float y) {
		...
		BodyEditorLoader loader = new BodyEditorLoader(
				Gdx.files.internal("papanikolis/submarine-shape.json"));
	 ...
	 */
	public void crashed() {
		submarine.setTexture(game.getAssetManager().get(
				"papanikolis/submarine-crashed-64x32.png", Texture.class));
		crashed = true;
	}
